...
public class LAVIEJALOBBY : MonoBehaviourPunCallbacks
{

	public static LAVIEJALOBBY lobby; //references the instance of this class between our product. (singleton) 
